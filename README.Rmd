...
[![Codecov test coverage](https://codecov.io/gh/mrcaseb/ggpath/branch/main/graph/badge.svg)](https://app.codecov.io/gh/mrcaseb/ggpath?branch=main)
...
There are various ggplot2 extensions that provide more or less easy APIs for plotting images. These include but not limited to
...
- functions to plot images in both the panel (with [`geom_from_path`](https://mrcaseb.github.io/ggpath/reference/geom_from_path.html)) and all other plot areas (with [`element_path`](https://mrcaseb.github.io/ggpath/reference/element_path.html)),
...
Until ggpath is available on CRAN, the only way to install it is from [GitHub](https://github.com/mrcaseb/ggpath), for example with:
